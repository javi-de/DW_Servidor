    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(request.getParameter("butEnviar")!= null){
            ...
            if(error.equals("")){
                formEnviado= true;
                try{
                    link= "archivos/seccionesfavoritas.txt";

                    BufferedWriter bw= new BufferedWriter(new FileWriter(getServletContext().getRealPath("/archivos/seccionesfavoritas.txt")));
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<body>");
                ...
                out.println("<form action='' method='POST'>");
                    ...
                    try{
                        File fileSecciones= new File(getServletContext().getRealPath("archivos/secciones.txt"));
                        ...
                        while(reader.hasNextLine()){
                            ...
                            out.println("<label for='secciones" + cont + "'>" + linea + "</label><br>");
                            cont++;
                        }
                        reader.close();
